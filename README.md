...
- [X] Mention two parts of Express that you learned about this week.
  ...
  I learned how to create custom Express middleware along with deploying apps to Heroku.  
  
- [X] Describe Middleware?

  Middleware proivdes a way to extend the features provided by the Express framework.

- [ ] Describe a Resource?
  ?
- [X] What can the API return to help clients know if a request was successful?
  
  A response status of 200(ok), indicating everything worked as expected. 

- [X] How can we partition our application into sub-applications?

  We can use a middleware that allows us to seperate our routes into different files. Leading to more organized code.
